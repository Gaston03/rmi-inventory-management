package ma.supmti.inventoryclient.utils;

import ma.supmti.dtos.ProductDTO;
import ma.supmti.inventoryclient.config.RemoteListenner;
...
public class ProductUtils {
    ...
    public static void promptToUpdateProduct(Scanner sc, RemoteListenner listener) throws RemoteException, SQLException {
        ...
        System.out.println("Updating product with: " + product);
    ...
    public static void promptToListProducts(Scanner sc, RemoteListenner listener) throws RemoteException, SQLException {
